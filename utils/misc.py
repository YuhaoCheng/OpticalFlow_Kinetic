...
def save_args(config, filename='config.json'):
    cfg_dict = config.dump()
    check_path(config.SYSTEM.checkpoint_dir)
    save_path = os.path.join(config.SYSTEM.checkpoint_dir, filename)
